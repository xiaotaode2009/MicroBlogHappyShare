 ...
 *
 */
public class WAuthorizeActivity extends Activity  implements PlatformActionListener,Callback{

	private Platform weixin = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		weixin = ShareSDK.getPlatform(WAuthorizeActivity.this,Wechat.NAME);
	...
	public void onComplete(Platform arg0, int arg1, HashMap<String, Object> arg2) {
		String userInfo = weixin.getDb().exportData();
