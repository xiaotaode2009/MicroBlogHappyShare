...
import com.seclab.microblogshare.ui.TimeLineActivity;
...
public class AccountAdapter extends BaseAdapter {
	...
	public ArrayList<Account> mData;
	...
	holder.ll.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (plf.equals("sina")) {
					...
					intent.setClass(ctx,TimeLineActivity.class);
